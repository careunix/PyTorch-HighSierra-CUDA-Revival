...
<pre>
____      _           _        ____                 _             _
/ ___|__ _| | ___  ___| | __   |  _ \ ___  _ __ ___ (_)_ __   __ _| |
| |   / _` | |/ _ \/ __| |/ /   | |_) / _ \| '_ ` _ \| | '_ \ / _` | |
| |__| (_| | |  __/ (__|   <    |  _ < (_) | | | | | | | | | | (_| | |
 \____\__,_|_|\___|\___|_|\_\   |_| \_\___/|_| |_| |_|_|_| |_|\__,_|_|
</pre>
</div>
...
# 🔥 PyTorch High Sierra CUDA Revival  
## **The Final Fully GPU-Accelerated Deep Learning Stack for macOS**

<p align="center"><b>
This project restores full CUDA compute support on macOS High Sierra using NVIDIA CUDA 10.2, cuDNN 7.6.5, and a custom‑built PyTorch 1.7.0.<br>
A completely discontinued ecosystem — resurrected and preserved.
</b></p>

<p align="center">
  <img src="assets/banner_monochrome.svg" alt="CUDA Revival · High Sierra" width="640">
</p>
...
# 🧩 Supported GPUs (All WebDriver-Compatible)
...
# 📚 Documentation & Preservation Index
...
- System probe (GPU, driver, CUDA, cuDNN → JSON): `python scripts/system_probe.py --out environment/system_specs.json`
...
# 🤖 GPT‑2 Medium Inference Example
...
<p align="center">
  <b>Preserving the final NVIDIA‑powered AI stack ever possible on macOS.</b><br>
